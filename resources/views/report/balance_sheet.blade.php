                                            ...
                                            @foreach ($accounts as $key => $account)
                                                <tr>
                                                    ...
                                                    <td style="background-color: #C5F0C7">
                                                        {{ number_format($accountDepositSums[$account->id]['depositInvoiceSum'] + $accountDepositSums[$account->id]['InvoiceSum'] + $accountDepositSums[$account->id]['remainInvoice'] + $accountDepositSums[$account->id]['totalIn']) }}
                                                    </td>
                                                    <td style="background-color: #FBCCCC">
                                                        {{ number_format($accountDepositSums[$account->id]['depositPurchaseOrderSum'] + $accountDepositSums[$account->id]['depositSaleReturnSum'] + $accountDepositSums[$account->id]['expense'] + $accountDepositSums[$account->id]['PurchaseOrderSum'] + $accountDepositSums[$account->id]['remainPurchaseOrderSum'] + $accountDepositSums[$account->id]['totalOut']) }}
                                                    </td>
                                                </tr>
                                            @endforeach
