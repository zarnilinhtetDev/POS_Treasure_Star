        ...
        $(document).ready(function() {
            ...
            $(document).on("click", '#calculate', function(e) {
                ...
                for (let i = 0; i <= count; i++) {
                    ...
                    let buyPrice = parseFloat($('#buy_price-' + i).val()) || 0;
                    ...
                    total += itemTotal;
                    $("#result-" + i).text((itemTotal - discount).toFixed(2));
                }

                totalPurchase = totalPurchase + total;
                let totalTotal = total - totalDiscount;
                $("#invoiceyoghtml").val(total.toFixed(2));
                $("#item_discount").val(totalDiscount);
                $("#total_buy_price").val(totalPurchase.toFixed(2));
                $("#total").val(totalTotal.toFixed(2));
                $('#total_total').val(totalTotal.toFixed(2));
                $('#total_discount').val('');
            });
