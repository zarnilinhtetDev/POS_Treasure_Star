...
<head>
    ...
    <style>
        ...
        .underline-dashed {
            ...
            text-underline-offset: 5px; /* Optional: Adjusts the distance of the underline */
        }
    ...
    <div class="voucher">
        ...
        <div class="header">
            ...
            <div class="d-flex justify-content-between">
                <p class="mt-4"><strong>HO No:</strong><span class="underline-dashed">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>
                <h3 class="mt-0 mb-0 text-center" style="padding: 10px;text-decoration: underline"><strong>Cash
                        Voucher</strong></h3>
                <div class="mt-4">
                    <p><strong>Voucher No:</strong><span class="underline-dashed">&nbsp;&nbsp;&nbsp;{{$invoice->invoice_no}}&nbsp;&nbsp;&nbsp;</span></p>
                    <p><strong>Date:</strong><span class="underline-dashed">&nbsp;&nbsp;&nbsp;{{date_format(new DateTime(), 'd-m-Y')}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></p>
                </div>
            </div>
        </div>
        <div class="content text-center">
            <p><strong>Received From:</strong><span class="underline-dashed">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{$invoice->customer_name}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
            </p>
        </div>
