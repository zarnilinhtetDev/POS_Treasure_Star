                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="frmSearch col-sm-6">
                                                        <div class="frmSearch col-sm-12">
                                                            <div class="frmSearch col-sm-12">
                                                                <span style="font-weight:bolder">
                                                                    <label for="cst" class="caption">Register Mode</label>
                                                                </span>
                                                                <select name="balance_due" id="balance_due" class="mb-4 form-control balance_due" required>

                                                                    <option value="Invoice" @if ($invoice->balance_due == 'Invoice')
                                                                        selected
                                                                        @endif >Invoice</option>
                                                                    <option value="Po Return" @if ($invoice->balance_due == 'Po Return') selected

                                                                        @endif >Po Return</option>
