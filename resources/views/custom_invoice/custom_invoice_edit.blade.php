...
<body>
    ...
    <div class="container-fluid" id="content">
        ...
        <form method="post" id="myForm" action="{{ url('/custom_invoice_update', $invoice->id) }}"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <select name="item_unit[]"
                                                                    class="form-control item_unit" id="item_unit_0">

                                                                    @foreach ($units as $unit)
                                                                        <option value="{{ $unit->unit }}"
                                                                            @if ($unit->unit == $sell->unit) selected @endif>
                                                                            {{ $unit->unit }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </td>
        ...
        $(document).ready(function() {
            ...
            $("#addproduct").click(function(e) {
                ...
                let newRow = '<tr>' +
                    ...
                    '<td><select class="form-control item_unit " name="item_unit[]" id="item_unit-' +
                    count + '">';
                units.forEach(unit => {
                    newRow += '<option value="' + unit.unit + '">' + unit.unit + '</option>';
                });
